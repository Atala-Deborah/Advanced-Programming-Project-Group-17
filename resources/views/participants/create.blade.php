...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Add New Participant</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="Institution" id="Institution" required
                            ...
                            <option value="Other" {{ old('Institution') == 'Other' ? 'selected' : '' }}>Other</option>
                        </select>
                        @error('Institution')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="Affiliation" id="Affiliation" required
                            ...
                            <option value="CS" {{ old('Affiliation') == 'CS' ? 'selected' : '' }}>CS</option>
                            <option value="SE" {{ old('Affiliation') == 'SE' ? 'selected' : '' }}>SE</option>
